 ...
 * el servicio puede tener seguridad, como por ejemplo utenticacion basica.  
 * 
 * 
 * @Author Red hat
 */
...
public class RestoRestGatewayService {
    ...
    public String redirigirSolicitud() throws NoSuchAlgorithmException {
    try {
        // Configurar el cliente JAX-RS
